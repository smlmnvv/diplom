...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/gerb.png" type="image/x-icon">
    <title><?= $title ?? 'УСЗН по Шелаболихинскому району' ?></title>
</head>
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a href="https://t.me/uszn_she" class="header__social-link tg">
                    ...
                    <a href="https://ok.ru/usznposhel" class="header__social-link ok">
                ...
                <div class="col d-flex justify-content-between align-items-center">
                    ...
                    <nav class="nav">
                        <ul class="nav__ul d-flex">
                            ...
                            <li class="nav__li"><a href="/news" class="nav__item text-dark">
                                Новости
                            </a></li>
                            <li class="nav__li"><a href="/documents" class="nav__item text-dark">
                                Документы
                            </a></li>
                            <li class="nav__li"><a href="/feedback" class="nav__item text-dark">
                                Обратная связь
                            </a></li>
                        </ul>
                    </nav>
